...
- [ ] **INPUT-02**: User can manually enter all proposal fields in a form (system size, 12-month production, 12-month consumption, current rate, system cost, financing terms, customer name/address)
