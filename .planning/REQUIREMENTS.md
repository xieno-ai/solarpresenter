...
- [x] **INPUT-04**: User can upload a utility bill (PDF, photo, or scan) and AI extracts electricity usage, utility company, energy rate, all-in rate, account holder, and service address
- [x] **INPUT-05**: Bill extraction outputs data in a structured format ready to input into SunPitch or populate the manual entry form
...
| INPUT-04 | Phase 7: Bill Extraction | Complete |
| INPUT-05 | Phase 7: Bill Extraction | Complete |
